...
export default function Hero() {
  return (
    <section className="relative m-auto max-w-[108rem]">
      <div className="relative flex items-center justify-center bg-[url('/public/hero.webp')] rounded-[2.25rem] bg-cover bg-bottom pb-[56.25%]">
        <div className="absolute top-0 left-0 right-0 bottom-0 flex justify-center text-center">
          <div>
            ...
            <p className="text-[1.75rem]/10.5 text-white">Where your unforgettable adventures await you</p>
          </div>
        </div>
