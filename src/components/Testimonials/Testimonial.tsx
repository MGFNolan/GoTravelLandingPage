...
export default function Testimonial({testimonial}: TestimonialProps) {
  return (
    <li className="relative ml-24 flex rounded-3xl bg-white py-14 pt-14 pr-12 pl-42 drop-shadow-[0px_0px_20px_rgba(0,0,0,0.05)]">
      <div className="absolute left-0 -translate-x-[50%] size-47.5 transform overflow-hidden after:absolute after:bg-primary-700 after:right-0 after:bottom-0 after:-z-1 after:block after:size-45 after:rounded-full">
