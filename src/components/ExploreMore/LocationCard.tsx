  ...
  return (
    ...
    className="group cursor-pointer">
        <div className="relative mb-8 overflow-hidden rounded-3xl">
            ...
            <div className="absolute top-5 right-6 flex items-center gap-x-2 rounded-[0.625rem] bg-white/85 backdrop:blur-3xl px-3 py-1.5">
                <Star className="size-6 fill-yellow"/>
                <p className="text-grey-600 teacking-6 text-[1.0625rem] font-semibold">{location.rating}</p>
            </div>
        </div>
